<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
    ...
    <a href="<?php echo e(route('dashboard')); ?>">
        <img src="<?php echo e(asset('C:\Users\User\Downloads\project2/download.png')); ?>" alt="Your Custom Logo" class="block h-9 w-auto" />
    </a>
</div>
...
<?php endif; ?>
            ...
            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <?php if (isset($component)) { $__componentOriginal71c6471fa76ce19017edc287b6f4508c = $component; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.nav-link','data' => ['href' => ''.e(route('wishlist')).'','active' => request()->routeIs('wishlist')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('nav-link'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(Illuminate\View\AnonymousComponent::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['href' => ''.e(route('wishlist')).'','active' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(request()->routeIs('wishlist'))]); ?>
                        <?php echo e(__('WishListController')); ?>
...
<?php /**PATH C:\Users\User\Downloads\project2\resources\views/navigation-menu.blade.php ENDPATH**/ ?>